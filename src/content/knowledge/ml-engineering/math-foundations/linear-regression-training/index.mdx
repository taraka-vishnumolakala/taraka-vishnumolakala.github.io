...
<MathConceptLab
	...
	title="Fit a line to completed alerts"
	description="Each outlined point is one completed investigation. Apply updates and watch the model’s line move toward the observations while mean squared error falls."
/>
...
<Collapsible title="1. What are the four parts of one training update?">
...
<Collapsible title="2. Why square the prediction errors?">
...
<Collapsible title="4. Why does the fitted line not pass through every point?">
...
<Collapsible title="5. Why do we need validation data after training?">
...
<PracticeLink href="https://neetcode.io/problems/linear-regression-training/question" prefix="Implement the training loop in">NeetCode’s Linear Regression (Training) problem</PracticeLink>
