...
<MathConceptLab
	mode="activations"
	title="Transform a file-review score"
	description="The input is an internal score produced by one neuron, not the original file and not a final verdict. Choose a function and move the score to see how its output changes."
/>
...
<Collapsible title="1. What does an activation function do?">
...
<Collapsible title="2. What does sigmoid return when its input is zero?">

It returns `0.5`, the midpoint of its 0-to-1 range.

</Collapsible>

<Collapsible title="3. What does ReLU return for an input of −3? What about 3?">
...
<Collapsible title="4. Why can sigmoid slow learning at very large inputs?">
...
<Collapsible title="5. Does a sigmoid output of 0.95 prove that a file is malicious?">
...
<PracticeLink href="https://neetcode.io/problems/sigmoid-and-relu/question" prefix="Implement both functions in">NeetCode’s Sigmoid and ReLU problem</PracticeLink>
