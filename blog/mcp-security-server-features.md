...
#### Vulnerable and fixed: path-templated traversal
...
#### Vulnerable and fixed: cross-tenant resource list
...
#### Vulnerable and fixed: content vs structuredContent drift
...
#### Vulnerable and fixed: secret leak via notifications/message
...
#### Vulnerable and fixed: cross-tenant cursor replay
