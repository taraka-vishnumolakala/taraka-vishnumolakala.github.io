...
<MathConceptLab
	mode="linear-forward"
	title="Estimate investigation effort"
	description="Change the endpoint count, analyst-hours per endpoint, or baseline effort. The dot shows the model’s current prediction on the line."
/>
...
<Collapsible title="1. What does the forward pass do?">
...
<Collapsible title="2. What happens when the bias increases by 3?">
...
<Collapsible title="3. What happens when the weight increases?">
...
<Collapsible title="4. Why is the prediction written as y hat instead of y?">
...
<Collapsible title="5. What stays the same when the model gains more features?">
...
<PracticeLink href="https://neetcode.io/problems/linear-regression-forward/question" prefix="Implement the forward pass in">NeetCode’s Linear Regression (Forward) problem</PracticeLink>
